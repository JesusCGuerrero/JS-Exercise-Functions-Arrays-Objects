...
function getModelYears(/* code here */inventory) {
  /* code here */
  let result = inventory.map(a => a.car_year);
  return result;
}
...
function getOlderCars(/* code here */inventory, maxYear) {
  /* code here */
  let result = inventory.filter(a => a.car_year <= maxYear)
  return result;
}
...
function getGermanCars(/* code here */inventory) {
  /* code here */
  const answer = inventory.filter(function(a) {return a.car_make === "Audi" || a.car_make === "Mercedes-Benz" || a.car_make === "Volkswagen" || a.car_make === "BMW"});
  return answer;
}
